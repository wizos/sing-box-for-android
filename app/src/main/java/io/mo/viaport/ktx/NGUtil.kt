...
object NGUtil {
     ...
     * base64 decode
     */
    fun decodeBase64Compat(text: String): String {
    ...
    fun tryDecodeBase64(text: String): String? {
        try {
            return text.base64UrlDecoded
        } catch (e: Exception) {
            XLog.i( "Parse base64 url safe failed $e")
        }
        try {
            return text.base64Decoded
        } catch (e: Exception) {
            XLog.i( "Parse base64 standard failed $e")
        }
        return null
    }
